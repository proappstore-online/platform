...
| Background / scheduled work | **unsupported today** — idempotent, bounded, privileged sweep action triggered from a privileged client | [PAS-DATA-019](https://docs.proappstore.online/standard/data/#pas-data-019) | — | browser timers, external cron, own Worker |
