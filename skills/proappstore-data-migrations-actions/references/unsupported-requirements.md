...
| Scheduled or background execution (reapers, digests, nightly recomputes) | no cron for static apps | an idempotent, `LIMIT`-bounded, role-gated sweep action triggered from a privileged session; documented in the README | [PAS-DATA-019](https://docs.proappstore.online/standard/data/#pas-data-019); platform issue #123 |
