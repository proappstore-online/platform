...
| Registration step | run log: `Registered N app tool(s)`; `list_app_tools` | N equals the committed manifest; no warnings about missing columns | [PAS-STACK-008](https://docs.proappstore.online/standard/stack/#pas-stack-008) |
