...
**Standard version 1.5** · Chapter `INT` · Part of the [Application Standard](./index.md)
...
No clauses are published in this chapter at standard version 1.5. Clauses are
