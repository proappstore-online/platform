...
**Standard version 1.4** · Chapter `INT` · Part of the [Application Standard](./index.md)
...
No clauses are published in this chapter at standard version 1.4. Clauses are
