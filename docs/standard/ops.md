...
**Severity:** Medium · **Verification:** Manual · **Enforcement:** automated — platform limits: app logs 50 000 entries/day and 200/s burst per app (over-budget answers 202 and the SDK backs off 60 s); proxy 10 000 requests/day per app and 1 000 per user; credential sign-in 10 failures/15 min per login; license validation 10/min per caller; KV 1 MB and 100 keys per user; rooms 32 peers/room, 64 rooms/app, 100 msg/s, 4 KB; uploads 50 MB; 120 actions/app; 5 secrets and 5 proxy rules per app · **Since:** 1.5
